...
&nbsp;&nbsp;&nbsp;&nbsp;a). Services file name should be end with service eg. my-service.js<br/>
&nbsp;&nbsp;&nbsp;&nbsp;b). Controller file name should be end with controller eg. my-controller.js<br/>
&nbsp;&nbsp;&nbsp;&nbsp;c). same as other file<br/>
